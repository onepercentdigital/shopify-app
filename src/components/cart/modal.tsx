...
import { getCheckoutUrl } from '@/lib/cart/server';
              ...
              {!cart || cart.lines.length === 0 ? (
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                  ...
                  <div className="py-4 text-neutral-500 text-sm dark:text-neutral-400">
                    ...
                    <div className="mb-3 flex items-center justify-between border-neutral-200 border-b py-1 dark:border-neutral-700">
                      <p>Shipping</p>
...
function CloseCart({ className }: { className?: string }) {
  return (
    <div className="relative flex size-11 items-center justify-center rounded-md border border-neutral-200 text-black transition-colors dark:border-neutral-700 dark:text-white">
      <XMarkIcon
        className={clsx(
